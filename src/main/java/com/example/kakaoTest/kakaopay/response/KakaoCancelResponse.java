...
import com.example.kakaoTest.kakaopay.dto.ApprovedCancelAmount;
import com.example.kakaoTest.kakaopay.dto.CancelAvailableAmount;
import com.example.kakaoTest.kakaopay.dto.CanceledAmount;
...
public class KakaoCancelResponse {
    ...
    private String cid;     // 가맹점 코드 (테스트코드)
